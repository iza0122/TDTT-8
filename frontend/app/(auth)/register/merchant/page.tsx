...
import { Eye, EyeOff, Mail, Lock, User, Store, Check, AlertCircle, ChevronRight, ArrowRight } from "lucide-react";
...
export default function MerchantRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-black flex items-center justify-center p-4 overflow-hidden relative select-none antialiased">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[350px] md:w-[450px] h-[350px] md:h-[450px] rounded-full bg-gradient-to-tr from-blue-500/10 via-cyan-500/15 to-teal-500/10 blur-[80px] md:blur-[100px] pointer-events-none z-0" />
      ...
      <div className="relative w-full max-w-md bg-white/40 dark:bg-neutral-900/10 border border-neutral-200/50 dark:border-white/5 rounded-[2.5rem] p-5 backdrop-blur-xl shadow-2xl z-10 animate-in fade-in slide-in-from-bottom-6 duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] my-6">
        ...
        <div className="bg-white dark:bg-neutral-950/45 border border-neutral-100/70 dark:border-white/5 rounded-[calc(2.5rem-0.75rem)] p-6 space-y-5 shadow-[inset_0_1px_2px_rgba(255,255,255,0.08)]">
          ...
          <div className="text-center space-y-3">
            <div className="w-14 h-14 bg-blue-500/10 border border-blue-500/20 rounded-2xl flex items-center justify-center mx-auto shadow-sm animate-bounce duration-[2000ms]">
              <Store className="w-8 h-8 text-blue-500" />
            </div>
            
            <div className="space-y-1">
              <span className="text-[9px] uppercase tracking-[0.25em] font-black text-blue-500 block">Foodiegram Business</span>
              <h2 className="text-2xl font-black tracking-tight text-foreground bg-gradient-to-b from-neutral-800 to-neutral-600 dark:from-white dark:to-neutral-400 bg-clip-text text-transparent">Đăng ký Đối tác</h2>
              <p className="text-xs text-muted-foreground/80 font-semibold">Quản lý cửa hàng và tiếp cận khách hàng tiềm năng</p>
            </div>
          </div>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-3.5">
            ...
            {/* Họ và tên field */}
            <div className="space-y-1">
              <Label htmlFor="name" className="text-[10px] uppercase tracking-wider font-extrabold text-muted-foreground/75 px-1">Họ và tên chủ quán</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "pl-10.5 h-11.5 rounded-2xl bg-secondary/35 hover:bg-secondary/50 dark:bg-white/5 border border-border/40 focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 focus:outline-none transition-all duration-300 font-semibold text-xs",
            ...
            {/* Email field */}
            <div className="space-y-1">
              <Label htmlFor="email" className="text-[10px] uppercase tracking-wider font-extrabold text-muted-foreground/75 px-1">Email liên hệ</Label>
              <div className="relative">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "pl-10.5 pr-10.5 h-11.5 rounded-2xl bg-secondary/35 hover:bg-secondary/50 dark:bg-white/5 border border-border/40 focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 focus:outline-none transition-all duration-300 font-semibold text-xs",
            ...
            <div className="flex items-start gap-2.5 px-1.5 pt-1.5">
              <Checkbox
                ...
                className="w-4.5 h-4.5 mt-0.5 rounded-md border-border/80 text-blue-500 focus:ring-blue-500/10"
              />
              <Label htmlFor="terms" className="text-[11px] font-semibold text-muted-foreground/80 cursor-pointer leading-relaxed select-none">
                ...
                và{" "}
                <Link href="/privacy" className="text-blue-500 font-bold hover:underline">
                  Chính sách bảo mật
                </Link>
              </Label>
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-blue-500 hover:bg-blue-600 hover:shadow-blue-500/10 text-white shadow-md hover:shadow-lg flex items-center justify-between rounded-full pl-6 pr-2.5 py-5 font-extrabold text-[11px] select-none transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] active:scale-95 group cursor-pointer mt-2 border-none"
              disabled={isLoading}
            >
              <span>{isLoading ? "Đang đăng ký..." : "Đăng ký tài khoản Đối tác"}</span>
          ...
          <p className="text-center mt-5 text-xs text-muted-foreground/80 font-semibold select-none">
            Đã có tài khoản?{" "}
            <Link href="/login" className="text-blue-500 font-extrabold hover:underline">
              Đăng nhập ngay
            </Link>
          </p>
