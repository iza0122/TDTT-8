...
# Định nghĩa hàm chạy di chuyển cấu trúc (Migrations) khi khởi động
...
# Chỉ tự động chạy migrations khi chạy ở môi trường phát triển cục bộ (Local Dev)
# Bỏ qua hoàn toàn trên Vercel production để tăng tốc khởi động lạnh (Cold Start) cho Serverless
if settings.ENV == "development" and not os.environ.get("VERCEL"):
    print("[MIGRATION] Đang kiểm tra và chạy đồng bộ cấu trúc Database...")
